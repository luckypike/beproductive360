class Member < ApplicationRecord
  ...
  def send_text
    if accepted?
      msg = "#{title}! Подтверждаем Вашу регистрацию на Форум «Производительность 360». Обращаем внимание что основной день мероприятия — 16 мая. Подробности на портале beproductive360.ru"
    elsif rejected?
